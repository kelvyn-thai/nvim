...
local config = {
  ...
  chat_shortcut_respond = { modes = { "n", "i", "v", "x" }, shortcut = "<leader>g<leader>g" },
  chat_shortcut_delete = { modes = { "n", "i", "v", "x" }, shortcut = "<leader>gd" },
  chat_shortcut_stop = { modes = { "n", "i", "v", "x" }, shortcut = "<leader>gs" },
  chat_shortcut_new = { modes = { "n", "i", "v", "x" }, shortcut = "<leader>gc" },
...
-- Chat commands
-- vim.keymap.set({ "n", "i" }, "<leader>gnc", "<cmd>GpChatNew<cr>", keymapOptions "New Chat")
-- vim.keymap.set({ "n", "i" }, "<leader>gng", "<cmd>GpChatRespond<cr>", keymapOptions "Respond Chat")
-- vim.keymap.set({ "n", "i" }, "<leader>gnt", "<cmd>GpChatToggle<cr>", keymapOptions "Toggle Chat")
-- vim.keymap.set({ "n", "i" }, "<leader>gnf", "<cmd>GpChatFinder<cr>", keymapOptions "Chat Finder")
--
...
--
-- -- optional Whisper commands with prefix <leader>gw
...
--
-- vim.keymap.set({ "n", "i" }, "<leader>gwr", "<cmd>GpWhisperRewrite<cr>", keymapOptions "Whisper Inline Rewrite")
-- vim.keymap.set({ "n", "i" }, "<leader>gwa", "<cmd>GpWhisperAppend<cr>", keymapOptions "Whisper Append (after)")
-- vim.keymap.set({ "n", "i" }, "<leader>gwb", "<cmd>GpWhisperPrepend<cr>", keymapOptions "Whisper Prepend (before) ")
--
-- vim.keymap.set("v", "<leader>gwr", ":<C-u>'<,'>GpWhisperRewrite<cr>", keymapOptions "Visual Whisper Rewrite")
-- vim.keymap.set("v", "<leader>gwa", ":<C-u>'<,'>GpWhisperAppend<cr>", keymapOptions "Visual Whisper Append (after)")
-- vim.keymap.set("v", "<leader>gwb", ":<C-u>'<,'>GpWhisperPrepend<cr>", keymapOptions "Visual Whisper Prepend (before)")
--
...
-- vim.keymap.set({ "n", "i" }, "<leader>gwn", "<cmd>GpWhisperNew<cr>", keymapOptions "Whisper New")
-- vim.keymap.set({ "n", "i" }, "<leader>gwv", "<cmd>GpWhisperVnew<cr>", keymapOptions "Whisper Vnew")
-- vim.keymap.set({ "n", "i" }, "<leader>gwt", "<cmd>GpWhisperTabnew<cr>", keymapOptions "Whisper Tabnew")
--
...
-- vim.keymap.set("v", "<leader>gwn", ":<C-u>'<,'>GpWhisperNew<cr>", keymapOptions "Visual Whisper New")
-- vim.keymap.set("v", "<leader>gwv", ":<C-u>'<,'>GpWhisperVnew<cr>", keymapOptions "Visual Whisper Vnew")
-- vim.keymap.set("v", "<leader>gwt", ":<C-u>'<,'>GpWhisperTabnew<cr>", keymapOptions "Visual Whisper Tabnew")
